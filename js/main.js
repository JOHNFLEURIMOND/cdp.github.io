...
function appendData(data) {
  ...
  for (var i = 0; i < data[0].clients.stations.length; i++) {
    ...
    div.innerHTML = "Client: " + <br/> + data[0].clients.stations[i].title + <br/> + data[0].clients.stations[i].description + <br/> + data[0].clients.stations[i].address + <br/> + data[0].clients.stations[i].logo;
